...
function gml_node_tools_is_in_block(l_q,l_p){
	...
	switch(l__g.__enumIndex__){
		...
		case 105:return l_q!=l__g.h_cond;
		case 104:return l_q!=l__g.h_cond;
		case 106:return l_q!=l__g.h_times;
		case 107:return l_q!=l__g.h_cond;
		case 100:return l_q!=l__g.h_expr;
		default:return false;
	}
}
...
function gml_node_tools_equals(l_a,l_b){
	...
	switch(l__g.__enumIndex__){
		...
		case 97:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==97)return gml_node_tools_equals_list(l__g.h_nodes,l__g1.h_nodes); else return false;
		case 98:
		...
		case 101:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==101)return gml_node_tools_equals(l__g.h_time,l__g1.h_time); else return false;
		case 103:
			var l__g1=l_b;
		...
		case 109:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==109)return gml_node_tools_equals(l__g.h_node,l__g1.h_node); else return false;
		case 110:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==110)return gml_node_tools_equals(l__g.h_v,l__g1.h_v); else return false;
		case 45:
			var l__g1=l_b;
		...
		case 116:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==116)return gml_node_tools_equals(l__g.h_x,l__g1.h_x); else return false;
		case 117:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==117)return l__g.h_s==l__g1.h_s; else return false;
		case 118:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==118){
				var l_b_s=l__g1.h_s;
				var l_b_x=l__g1.h_x;
		...
		case 121:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==121)return l__g.h_s==l__g1.h_s; else return false;
		case 40:
			var l__g1=l_b;
...
function gml_node_tools_clone(l_q){
	...
	switch(l__g.__enumIndex__){
		...
		case 96:return gml_node_var_decl(l_d,l__g.h_name,gml_node_tools_clone_opt(l__g.h_value));
		case 97:
		...
		case 98:return gml_node_if_then(l_d,gml_node_tools_clone(l__g.h_cond),gml_node_tools_clone(l__g.h_then),gml_node_tools_clone_opt(l__g.h_not));
		case 99:return gml_node_ternary(l_d,gml_node_tools_clone(l__g.h_cond),gml_node_tools_clone(l__g.h_then),gml_node_tools_clone(l__g.h_not));
		case 33:return gml_node_postfix(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_inc);
		case 101:return gml_node_wait(l_d,gml_node_tools_clone(l__g.h_time));
		case 102:return gml_node_fork(l_d);
		case 103:return gml_node_while(l_d,gml_node_tools_clone(l__g.h_cond),gml_node_tools_clone(l__g.h_node));
		case 104:return gml_node_do_until(l_d,gml_node_tools_clone(l__g.h_node),gml_node_tools_clone(l__g.h_cond));
		case 105:return gml_node_do_while(l_d,gml_node_tools_clone(l__g.h_node),gml_node_tools_clone(l__g.h_cond));
		case 106:return gml_node_repeat(l_d,gml_node_tools_clone(l__g.h_times),gml_node_tools_clone(l__g.h_node));
		case 107:return gml_node_for(l_d,gml_node_tools_clone(l__g.h_pre),gml_node_tools_clone(l__g.h_cond),gml_node_tools_clone(l__g.h_post),gml_node_tools_clone(l__g.h_loop));
		case 108:return gml_node_with(l_d,gml_node_tools_clone(l__g.h_ctx),gml_node_tools_clone(l__g.h_node));
		case 109:return gml_node_once(l_d,gml_node_tools_clone(l__g.h_node));
		case 110:return gml_node_return(l_d,gml_node_tools_clone(l__g.h_v));
		case 111:return gml_node_exit(l_d);
		case 112:return gml_node_break(l_d);
		case 113:return gml_node_continue(l_d);
		case 114:return gml_node_debugger(l_d);
		case 115:return gml_node_try_catch(l_d,gml_node_tools_clone(l__g.h_node),l__g.h_cap,gml_node_tools_clone(l__g.h_cat));
		case 116:return gml_node_throw(l_d,gml_node_tools_clone(l__g.h_x));
		case 117:return gml_node_comment_line(l_d,l__g.h_s);
		case 118:return gml_node_comment_line_pre(l_d,l__g.h_s,gml_node_tools_clone(l__g.h_x));
		case 119:return gml_node_comment_line_post(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_s);
		case 120:return gml_node_comment_line_sep(l_d,l__g.h_s,gml_node_tools_clone(l__g.h_x));
		case 122:return gml_node_comment_block_pre(l_d,l__g.h_s,gml_node_tools_clone(l__g.h_x),l__g.h_pl);
		case 123:return gml_node_comment_block_post(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_s,l__g.h_pl);
		case 121:return gml_node_comment_block(l_d,l__g.h_s);
...
function gml_node_tools_seek_all(l_q,l_st,l_c){
	...
	var l__g=l_q;
	switch(l__g.__enumIndex__){
		case 110:l_r=l_c(l__g.h_v,undefined);break;
		...
		case 119:l_r=l_c(l__g.h_x,undefined);break;
		case 38:l_r=l_c(l__g.h_v,undefined);break;
		case 101:l_r=l_c(l__g.h_time,undefined);break;
		...
		case 116:l_r=l_c(l__g.h_x,undefined);break;
		case 9:l_r=l_c(l__g.h_obj,undefined);break;
		case 120:l_r=l_c(l__g.h_x,undefined);break;
		...
		case 107:
			...
			break;
		case 103:l_r=l_c(l__g.h_cond,undefined);break;
		case 108:l_r=l_c(l__g.h_ctx,undefined);break;
		case 105:l_r=l_c(l__g.h_node,undefined);break;
		case 104:l_r=l_c(l__g.h_node,undefined);break;
		case 106:l_r=l_c(l__g.h_times,undefined);break;
		case 100:
...
function gml_node_tools_seek(l_q,l_st,l_c){
	...
	switch(l__g.__enumIndex__){
		...
		case 101:l_r=l_c(l__g.h_time,l_st);break;
		case 102:l_r=false;break;
		case 103:
			var l_l_cond=l__g.h_cond;
		...
		case 108:
			...
			break;
		case 109:l_r=l_c(l__g.h_node,l_st);break;
		case 110:l_r=l_c(l__g.h_v,l_st);break;
		case 111:l_r=false;break;
		case 112:l_r=false;break;
		case 113:l_r=false;break;
		case 114:l_r=false;break;
		case 115:
			...
			break;
		case 116:l_r=l_c(l__g.h_x,l_st);break;
		case 117:l_r=false;break;
		case 118:l_r=l_c(l__g.h_x,l_st);break;
		case 119:l_r=l_c(l__g.h_x,l_st);break;
		case 120:l_r=l_c(l__g.h_x,l_st);break;
